...
export const Footer: React.FC<FooterProps> = ({ setActiveTab, onOpenLotLookup }) => {
  return (
    <footer className="bg-theme-surface border-t border-theme text-theme-secondary font-body text-xs pt-12 pb-8 transition-colors duration-150">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-theme">
          {/* Col 1: Brand Logo & Purpose */}
          <div className="space-y-3">
            <Logo size="md" />
            <p className="text-theme-muted text-[11px] leading-relaxed font-body">
            ...
            <div className="flex items-center gap-1.5 text-verified text-[11px] font-mono">
          ...
          <div className="font-interface">
            <h4 className="text-theme-primary uppercase tracking-wider font-bold mb-3 text-xs font-heading">
              Catalogue & Search
            </h4>
            <ul className="space-y-2 text-[11px]">
              <li>
                <button
                  ...
                  className="hover:text-amber-hover transition-colors text-left"
                >
            ...
            <ul className="space-y-2 text-[11px]">
              ...
              <li>
                <button
                  ...
                  className="hover:text-amber-hover transition-colors text-[#BE7A28] font-semibold text-left"
                >
          ...
          <div className="font-interface">
            ...
            <ul className="space-y-2 text-[11px]">
              <li className="text-theme-secondary">
                Institutional Support: <a href="mailto:support@bioscience.co" className="text-theme-primary font-mono hover:underline">support@bioscience.co</a>
              </li>
              <li className="text-theme-secondary">
                Quality & Release: <a href="mailto:qc@bioscience.co" className="text-theme-primary font-mono hover:underline">qc@bioscience.co</a>
              </li>
              <li>
                <button
                  onClick={() => setActiveTab('about')}
                  className="hover:text-amber-hover transition-colors underline text-left"
                >
        ...
        <div className="my-6 bg-theme-canvas border border-theme p-4 space-y-1.5 font-body text-xs transition-colors">
          <div className="flex items-center gap-1.5 text-theme-primary font-heading font-bold text-xs uppercase tracking-wider">
            <IconShieldCheck size={14} amberAccent={true} />
            <span>MANDATORY RESEARCH DISCLAIMER (§ 8.7 COMPLIANCE SPECIFICATION)</span>
          </div>
          <p className="text-[11px] text-theme-muted leading-relaxed font-body">
        ...
        {/* Bottom Rights */}
        <div className="flex flex-col sm:flex-row items-center justify-between text-[10px] text-theme-muted font-mono pt-3 border-t border-theme gap-2">
