  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-body space-y-12 bg-[#0A0B0D]">
      ...
      <div className="max-w-3xl space-y-3">
        ...
        <p className="text-sm text-[#B9BEC4] leading-relaxed font-body">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-xs">
        <div className="bg-[#16181B] p-5 border border-[#2A2E33] space-y-3">
          <div className="flex items-center gap-2 text-[#E8E6E1] font-heading font-bold uppercase">
            <IconBarChart size={18} amberAccent={true} />
            <span>HPLC Area Normalisation</span>
          </div>
          <p className="text-[#B9BEC4] font-body leading-relaxed text-xs">
          ...
          <span className="text-[10px] font-mono text-[#E8E6E1] font-semibold block border-t border-[#2A2E33] pt-2">
      ...
      {/* COA Lookup CTA Card */}
      <div className="bg-[#16181B] p-6 border border-[#2A2E33] text-xs flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-1.5">
          <h3 className="text-sm font-heading font-bold text-[#E8E6E1] uppercase tracking-widest flex items-center gap-2">
            <IconFileText size={16} amberAccent={true} />
            <span>Retrieve Official Certificate of Analysis</span>
          </h3>
          <p className="text-[#B9BEC4] text-xs font-body max-w-xl">
