...
export const LegalPage: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-body space-y-8 bg-[#0A0B0D]">
      {/* Header in Söhne Breit / Söhne */}
      <div className="space-y-3 border-b border-[#2A2E33] pb-6">
        ...
        <h1 className="font-display text-3xl font-bold text-[#E8E6E1] uppercase tracking-tight">
          Terms of Sale & Research Use Disclaimer
        </h1>
        <p className="text-xs text-[#6B7178] font-mono">
      ...
      <div className="bg-[#16181B] p-6 border border-[#2A2E33] space-y-3 font-body">
        ...
        <p className="text-xs text-[#B9BEC4] leading-relaxed font-body">
      ...
      <div className="space-y-6 text-xs font-body">
        {/* Article 1 */}
        <div className="space-y-1.5 bg-[#16181B] p-5 border border-[#2A2E33]">
          <h3 className="font-heading text-xs font-bold text-[#E8E6E1] uppercase tracking-wider">
